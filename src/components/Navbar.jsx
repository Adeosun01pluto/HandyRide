...
const Navbar = () => {
  ...
  const handleDesktopSearchKeyDown = (e) => {
    if (e.key === "Enter") {
      ...
      setOpen(false);
      scrollToTop();
      // On desktop we keep the query active
    }
  };
  ...
  const handleMobileSearchChange = (e) => {
    ...
    setSearchQuery(value); // filter in real-time as they type
  };

  const closeMobileSearchAndClearField = () => {
    setMobileSearchOpen(false);
  ...
  const handleMobileSearchKeyDown = (e) => {
    if (e.key === "Enter") {
      e.preventDefault();
      const value = mobileSearchValue.trim();

      // Apply final search
      setSearchQuery(value);

      // Make sure we are on the restaurants page
      ...
      // Close search UI & clear the input field
      closeMobileSearchAndClearField();
    }
  };
      ...
      >
        <div className="flex items-center justify-between px-2 md:px-16 lg:px-24 xl:px-32 py-3 relative">
          ...
          <div className="sm:hidden flex items-center gap-3">
            ...
            {mobileSearchOpen ? (
              <div className="flex items-center gap-2 border border-gray-300 px-3 rounded-full w-[60vw] max-w-xs bg-white">
                <input
                ...
                {mobileSearchValue ? (
                  ...
                  <button
                    onClick={closeMobileSearchAndClearField}
                    className="text-gray-400 hover:text-red-500 transition-colors"
                  >
                    <FiX className="w-4 h-4" />
                  </button>
              ...
              <button
                ...
                className="p-2 rounded-full border border-gray-300 hover:border-red-400 hover:bg-red-50 transition"
              >

...
import { MdEmail, MdLock, MdPerson, MdDirectionsBike, MdCheckCircle } from "react-icons/md";
...
const CustomerRegister = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessName(form.name.trim() || form.email.trim());
      ...
      <div className="w-full max-w-xl relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm max-w-md mx-auto">
            Register once and book rides on campus anytime. It takes less than a minute.
          </p>
        </div>
